...
_magic_number = 10
_modified_time = 1569297776.7098382
_enable_loop = True
...
def render_navbar_items(context,**pageargs):
    ...
    try:
        ...
        __M_writer(django_mako_plus.ExpressionPostProcessor(self)( 'active' if request.dmp.page =='store' else ' '))
...
"""
__M_BEGIN_METADATA
{"filename": "C:/Users/Isaac/mysite/homepage/templates/app_base.htm", "uri": "/homepage/templates/app_base.htm", "source_encoding": "utf-8", "line_map": {"29": 0, "42": 1, "47": 10, "52": 20, "57": 25, "63": 3, "71": 3, "72": 5, "73": 5, "74": 8, "75": 8, "81": 12, "87": 12, "93": 22, "99": 22, "105": 99}}
__M_END_METADATA
"""
